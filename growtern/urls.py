...
urlpatterns = [
    ...
    path('submit-task/', views.submit_task, name='task_submission'),
    ...
    path('assign_task/', views.create_task, name='assign_task'),
    ...
    path('edit_intern_v/', views.edit_intern1, name='edit_intern_v'),

    path('login/', views.login_view, name='login'),
    path('dashboard/', views.admin_dashboard, name='admin_dashboard'),
    path('leave-request/', views.leave_request, name='leave_request'),
    path('attendance/', views.attendance_tab, name='attendance_tab'),
    path('feedback/', views.submit_feedback_view, name='feedback'),
